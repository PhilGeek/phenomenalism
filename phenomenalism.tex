...
Like \citet{Moore:1903uo}, Cook Wilson emphasizes the distinction between the act of perceiving and the object of perception. In perceiving an object, the object appears to the subject, and so the subjective act of perceiving is sometimes described as an \emph{appearance}. Given the act--object distinction, an appearance, so understood, is necessarily distinguished from the object. However, Cook Wilson warns against a misleading ``objectification'' of appearing:
\begin{quote}
